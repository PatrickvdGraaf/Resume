...
public class ColorUtils {
    ...
    private static final int ANIM_COLOR_TRANSITION_DURATION = 250;
    ...
    public static void animateViewBackground(View view, int colorTo) {
        if (view.getBackground() == null) {
            view.setBackgroundColor(Color.GRAY);
        }
        ObjectAnimator a = ObjectAnimator.ofInt(view, "backgroundColor",
                ((ColorDrawable) view.getBackground()).getColor(), colorTo);
        a.setInterpolator(new LinearInterpolator());
        a.setDuration(ANIM_COLOR_TRANSITION_DURATION);
    ...
    public static void animateTextColor(TextView view, int colorTo) {
        ObjectAnimator a = ObjectAnimator.ofInt(view,
                "textColor",
